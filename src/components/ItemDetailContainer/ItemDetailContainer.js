...
function ItemDetailContainer(){
    ...
    //variable que simula el ingreso del ID del producta al hacer click en la card
    const mockItemID = 1;
    ...
    useEffect(()=>{
        getProducts()
        .then((dataList)=>{
            const encontrado = dataList.find(element => element.id === mockItemID)
            setItem(encontrado);
        }).finally(()=>{
